...
public class raketkadvijenie: MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space) && ball.GetComponent<ballmove>().gameover == true) // если игра проиграна и нажат пробел перезапуск сцены
        {
